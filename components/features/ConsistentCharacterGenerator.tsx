  ...
  const handleSubmit = async () => {
    ...
    try {
      for (let i = 0; i < numberOfImages; i++) {
        ...
        const newImage = await generateConsistentCharacterImage(characterImages, prompt, aspectRatio, quality);
      ...
      onSaveSession({
        ...
        parameters: { prompt, characterImages, aspectRatio, quality, numberOfImages },
      });
    } catch (e) {
