  ...
  const handleSubmit = async () => {
    ...
    try {
      for (let i = 0; i < numberOfImages; i++) {
        ...
        const newImage = await generatePoster(topic, slogan, posterType, style, aspectRatio, images, mainImageIndex, styleImage);
      ...
      onSaveSession({
        ...
        parameters: { topic, slogan, posterType, style, styleImage, aspectRatio, images, mainImageIndex, numberOfImages },
      });
    } catch (e) {
